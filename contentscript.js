...
function init() {		//初始化,旧,废弃
	chrome.extension.sendMessage({ask:"show"}, 
			function(response) {					
			});
}
...
//			 $(this).children().last().append("<span class=\"timestamp\"> ｜ <span style=\"color:#965F00;\">"+ts+"</span></span>");
			 $(this).children().last().append("<span class=\"timestamp\" style=\"color:#965F00;\">｜"+ts+"</span>");
		 }else{
//			 $(this).children().last().append("<span class=\"timestamp\"> ｜ <span style=\"color:#965F00;\">时间获取失败</span></span>");
			 $(this).children().last().append("<span class=\"timestamp\" style=\"color:#965F00;\">｜时间获取失败</span>");
		 }
	 });
}
